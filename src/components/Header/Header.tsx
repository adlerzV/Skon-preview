...
export default async function Header() {
  ...
  return (
    <header className="w-full sticky top-0 lg:top-[-60px] z-[10000]" dir="rtl">
      <div className="hidden lg:flex w-full justify-between items-center h-[60px]">
      ...
      <div className="hidden lg:flex w-full bg-brand-bg rounded-none py-[10px] gap-[8px] h-[80px]">
        ...
        <div className="flex items-center justify-center h-full bg-brand-surface hover:bg-brand-surface_hover duration-150 overflow-hidden group">
